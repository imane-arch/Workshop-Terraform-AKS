...
terraform {
  ...
  backend "azurerm" {
    resource_group_name  = "RG-IB-AKSCluster"         # mettre ici le nom du resource group de vos ressource
    storage_account_name = "backendterraimane"      # mettre le nom du compte de stockage créer dans le lab 1
